...
const NavBar = () => {
  ...
  return (
    <div className="flex-shrink-0 flex items-center">
      ...
      <button
        onClick={toggleTheme}
        className="ml-4 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100"
    ...
    <>
      ...
      <div
        className={`sticky-nav group m-auto w-full h-6 flex flex-row justify-between items-center mb-2 md:mb-12 py-8 bg-opacity-60 ${
          !fullWidth ? 'max-w-4xl' : 'px-4 md:px-24'
        }`}
        id="sticky-nav"
        ref={navRef}
